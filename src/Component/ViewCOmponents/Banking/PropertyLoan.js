        ...
        <Container fluid>
            ...
            <div className="col-lg-12">
              <div className="section_title_all text-start mt-3">
                <h3 className="font-weight-bold">
                  Arjun Group's{" "}
                  <span className="text-custom"> | Property Loan </span>
                </h3>
                <p className="text-start">
                  We help's you to make your dreams comes true, <br />
                  Lets get the Property Loan!.
                </p>
                <div className="">
                  <i className=""></i>
                </div>
          ...
          <div className="row vertical_content_manage mt-5">
            <div className="text-center mb-5">
              <h1> Property Loan in your hand in easy steps</h1>
            </div>
          </div>
          <div className="row vertical_content_manage">
            <div className="col-lg-6">
              <div>
                <img
                  src="https://rurashfin.com/wp-content/uploads/2022/07/LAP_Banner_1.jpeg"
                  width={"100%"}
                  height={"450px"}
                  alt=""
                />
            ...
            <div className="col-lg-6">
              <div>
                <img
                  src="https://fundmytra.com/blog/wp-content/uploads/2019/10/Loan-Against-Property-on-Cash-Flow-Basis.jpg"
                  width={"100%"}
                  height={"450px"}
                  alt=""
                />
